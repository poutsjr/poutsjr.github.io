	...
	if( $('.slideshow').length > 0 ) {
		$.supersized({
			...
			slides:  	[				// Slideshow Images
							{image : 'assets/img/sliders/slider1.jpg', title : '<div class="hero-text"><h2 class="hero-heading">INNOVATION</h2><p>Maîtriser les dernières technologies IT</p></div>', thumb : '', url : ''},
							{image : 'assets/img/sliders/slider2.jpg', title : '<div class="hero-text"><h2 class="hero-heading">ARCHITECTURE</h2><p>Mettre en place l\'outil correspondant au besoin</p></div>', thumb : '', url : ''},
							{image : 'assets/img/sliders/slider3.jpg', title : '<div class="hero-text"><h2 class="hero-heading">DEVELOPPEMENT</h2><p>Produire la brique applicative attendue</p></div>', thumb : '', url : ''}  
						],
		});
